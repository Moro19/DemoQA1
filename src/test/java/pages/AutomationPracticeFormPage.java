...
public class AutomationPracticeFormPage {
    public SelenideElement
            ...
            imageUpdateField = $("#uploadPicture"),
    ...
    public AutomationPracticeFormPage setUserBOD(String day, String month, String year) {
        ...
        new CalendarComponent().setDayOfBirthday(day, month, year);
        return this;
    }
    ...
    public AutomationPracticeFormPage setImage(File picture) {
        imageUpdateField.uploadFile(new File("src/test/java/resources/img/panda.jpg"));
        return this;
    }
